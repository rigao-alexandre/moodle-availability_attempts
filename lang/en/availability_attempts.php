...
$string['requires_not_attempts'] = 'User has not taken all attempts on the activity <strong>{$a}</strong>';
$string['title'] = 'Attempts';
$string['privacy:metadata'] = 'The Restriction by activity attempts plugin does not store any personal data.';
